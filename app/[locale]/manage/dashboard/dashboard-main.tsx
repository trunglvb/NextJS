...
export default function DashboardMain() {
	...
	const { data } = useQuery({
		queryKey: ["indicators", fromDate, toDate],
		queryFn: () => indicatorsApiRequest.getDashboard({ fromDate, toDate }),
	});

	const indicators = data?.payload.data;
		...
		<div className="space-y-4">
				...
				<Card>
					...
					<CardContent>
						<div className="text-2xl font-bold">
							{formatCurrency(indicators?.revenue || 0)}
						</div>
					</CardContent>
				</Card>
				<Card>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<div className="lg:col-span-4">
					<RevenueLineChart
						revenueByDate={indicators?.revenueByDate || []}
					/>
				</div>
				<div className="lg:col-span-3">
					<DishBarChart
						dishIndicator={indicators?.dishIndicator || []}
					/>
				</div>
			</div>
		</div>
